            ...
            <ul>
                {/* <li className="has-children">
                    ...
                    <ul className="sub-menu">
                        ...
                        <li><NavLink to={process.env.PUBLIC_URL + "/test1"}><span className="menu-text">Service</span></NavLink></li>
                        <li><NavLink to={process.env.PUBLIC_URL + "/test2"}><span className="menu-text">About us</span></NavLink></li>
                        <li><NavLink to={process.env.PUBLIC_URL + "/test3/1"}><span className="menu-text">WORK</span></NavLink></li>
                    </ul>
                </li> */}
                <li>
                ...
                <li>
                    <NavLink to={process.env.PUBLIC_URL + "/work/1"}><span className="menu-text">Work</span></NavLink>
                </li>
                <li>
